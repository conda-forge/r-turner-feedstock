...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-turner-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2551&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-turner-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-turner` can be installed with:

```
conda install r-turner
```

It is possible to list all of the versions of `r-turner` available on your platform with:
